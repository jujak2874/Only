	...
	<div id="placeI" class="chatListToggle">
		...
		<div id="chatRoomInput">
			<input class="chat" id="" type="text" name="chat"
				...
				style="float: left; width: 90%; height: 20px;"> <input
				class="send" id="" type="submit" value="보내기" data-chatRoom=""
				data-sendT="" data-getT=""
				style="float: left; height: 26px; width: 40%;"> <input
				class="FKKK" id="" type="submit" value="나가기"
